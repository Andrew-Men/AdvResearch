...
%                            'pad', 0) ;
% net.layers{end+1} = struct('type', 'conv', ...
%                            'weights', {{f*randn(4,4,10,500, 'single'),  zeros(1,500,'single')}}, ...
%                            'stride', 1, ...
%                            'pad', 0) ;
...
net.layers{end+1} = struct('type', 'conv', ...
                           ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'binaryerror') ;
...
% Meta parameters
net.meta.inputSize = [50 50 1] ;
net.meta.trainOpts.learningRate = 0.0000003 ;
net.meta.trainOpts.numEpochs = 20 ;
net.meta.trainOpts.batchSize = 2 ;
